...
The goal here is to see how we combine a *run* function that implements the algorithm in a generic way for any model (and in this case any node within the model), with a *setup* function that allows the algorithm to be used with a specific model (and node in this case).
